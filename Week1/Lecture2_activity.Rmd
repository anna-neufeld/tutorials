...
You will need to make a histogram for problem 4c in your homework! Hopefully you can figure out how to modify the code above so that this is seamless! 
...
Suppose that we want to study the relationship between the number of pets that someone has had and 
