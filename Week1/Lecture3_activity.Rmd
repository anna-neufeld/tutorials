...
Once you have done this, load the



Just in case you are unable to load the package, you can also download the data from my github website. I posted it here just in case.

```{r}
SaratogaHouses <- read.csv("https://anna-neufeld.github.io/stat202_tutorials/Week1/SaratogaHouses.csv")
```



airbnbs in New York City. Please load the data from the following link! I am still posting datasets to github for you to simplify the process of loading them into R. All you need to load this data is an internet connection! 



If you were successful, you should be able to view the first few rows of the data with the following command.
...
Today's tutorial is all about how we explore different types of variables and the relationship between them! We will go through different cases in order.


### One quantitative variable

Let's first focus on ``price``. 
