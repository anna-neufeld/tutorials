...
I am assuming that you are all familiar with the concepts of mean, median, and mode. We can compute these all easily in R! Usually, the name of the relevant ``R`` function is just the english name of the statistic we want to compute. If it is not, google can easily help you out.
