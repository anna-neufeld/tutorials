...
<div id="boxedtext">
**1e: What would be your pick for a "final model" for this dataset? Be sure that you can justify your answer!**
</div> 
...
<div id="boxedtext">
**2a: Perfect predictions:** What is $R^2$ in this model? To explain what is going on, compare your predicted values (stored in ``mod.full$fitted``) to the actual values of $y$ in your dataset. 
</div> 
...
As you can see, $R^2$ reaches its maximum when all 29 variables are included in the model. However, there are clearly some variables that improve $R^2$ more than others. After doing some visualizing and plotting of your data, answer the following question.


<div id="boxedtext">
**2b: Choosing a model:** Do you think that the best model is the one with the highest $R^2$? Why or why not?
</div> 
...
It is not, however, the case that the simplest model is always the best. Now consider the intercept-only model. 
